...
export class AuthenticationService {
   ...
   * @throws ApiError
   */
  public static login(formData: Body_login): CancelablePromise<LoginSuccess_Out> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/login',
      formData: formData,
   ...
   * @throws ApiError
   */
  public static adminLogin(email: string): CancelablePromise<LoginSuccess_Out> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/admin-login',
      query: {
   ...
   * @throws ApiError
   */
  public static getRefreshToken(requestBody: RefreshToken_In): CancelablePromise<LoginSuccess_Out> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static resetUserPassword(requestBody: ResetPassword_In): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static unlockUserAccount(userId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'PUT',
   ...
   * @throws ApiError
   */
  public static enable2Fa(requestBody: UpdateUser_In): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static getChartTokenForTemplateApi(formTemplateId: string): CancelablePromise<ChartToken_Out> {
    return __request(OpenAPI, {
      method: 'GET',
